...
if ( ! class_exists( 'Bricksable_PAnD' ) ) {

	/**
	 * Class Bricksable_PAnD
	 */
	class Bricksable_PAnD {
		...
		public static function init() {
			...
			add_action( 'wp_ajax_bricksable_lite_dismiss_admin_notice', array( __CLASS__, 'bricksable_lite_dismiss_admin_notice' ) );
		...
		public static function load_script() {
			...
			$js_url        = esc_url( BRICKSABLE_PLUGIN_ASSET_URL . '/js/vendor/dismiss-notice.js' );
			...
			wp_enqueue_script(
				'bricksable-lite-dismissible-notices',
				$js_url,
				array( 'jquery', 'common' ),
				'1.4.5',
				true
			...
			wp_localize_script(
				...
				'dismissible_notice',
				array(
					'nonce' => wp_create_nonce( 'bricksable-lite-dismissible-notice' ),
				)
			);
		}
		 ...
		 */
		public static function bricksable_lite_dismiss_admin_notice() {
			...
			check_ajax_referer( 'bricksable-lite-dismissible-notice', 'nonce' );
		...
		public static function get_admin_notice_cache( $id = false ) {
			...
			$cache_key = 'bricksable-lite-pand-' . md5( $id );
