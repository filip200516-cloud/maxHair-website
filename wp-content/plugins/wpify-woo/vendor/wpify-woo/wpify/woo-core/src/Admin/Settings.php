...
use WpifyWooDeps\Wpify\WooCore\Premium;
...
class Settings
{
    ...
    public function register_settings(): void
    {
        ...
        foreach ($plugins as $plugin_id => $plugin) {
            ...
            foreach ($sections as $section_id => $section) {
                ...
                $this->pages[$section_id] = array('page_title' => $section['title'], 'menu_title' => $section['title'], 'menu_slug' => $section['menu_slug'], 'id' => $section_id, 'parent_slug' => $section['parent'], 'class' => 'wpify-woo-settings', 'option_name' => $section['option_name'] ?? $this->get_settings_name($section['option_id']), 'tabs' => $this->is_current('', $section_id) ? $section['tabs'] : array(), 'items' => $this->is_current('', $section_id) ? $section['settings'] : array());
            }
        }
    ...
    public function get_plugins(): array
    {
        ...
        foreach ($all_plugins as $plugin_file => $plugin_data) {
            ...
            if (isset($plugin_data['Author']) && str_contains(strtolower($plugin_data['Author']), 'wpify')) {
                $wpify_plugins[$slug] = array('title' => $plugin_data['Name'], 'desc' => $plugin_data['Description'], 'icon' => '', 'version' => $plugin_data['Version'], 'doc_link' => '', 'support_url' => '', 'menu_slug' => '', 'option_id' => '', 'settings_url' => '', 'plugin_file' => $plugin_file, 'tabs' => [], 'settings' => []);
            }
        }
    ...
    public function register_menu_page()
    {
        ...
        add_submenu_page($this::DASHBOARD_SLUG, __('WPify Plugins Dashboard', 'wpify-core'), __('Dashboard', 'wpify-core'), 'manage_options', $this::DASHBOARD_SLUG, [$this, 'render_dashboard']);
        add_submenu_page($this::DASHBOARD_SLUG, __('WPify Plugins Support', 'wpify-core'), __('Support', 'wpify-core'), 'manage_options', $this::SUPPORT_MENU_SLUG, [$this, 'render_support'], 99);
    ...
    public function get_wpify_plugins_overview(): string
    {
                ...
                if (isset($extensions_map[$slug])) {
                    ...
                    if (!$update_data) {
                        ...
                        if (!is_wp_error($response) && !empty($response['body'])) {
                            $data = json_decode($response['body'], \true);
                        }
        ...
        $html .= $this->get_wpify_modules_blocks($installed_plugins, \true);
    ...
    public function render_support(): void
    {
        ...
        ?></a></p>
                    ...
                    <div class="wpify__card">
                        <div class="wpify__card-body">
                            <h3><?php 
        _e('If you haven’t found the answer, email us at:', 'wpify-core');
        ?></h3>
